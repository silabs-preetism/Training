    ...
    switch (per_command) {
      ...
      case COMMAND_8:
        ...
        scanf("%d"
              ...
              "%d",
              &cmd8.cmd_ix,
              &cmd8.transmit_enable,
              &*(uint32_t *)cmd8.access_addr,
              &cmd8.phy_rate,
              &cmd8.rx_chnl_num,
              &cmd8.tx_chnl_num,
              &cmd8.scrambler_seed,
      ...
      case COMMAND_9:
        ...
        scanf("%d"
              ...
              &cmd9.rf_type,
              &cmd9.rf_chain,
              &cmd9.ext_data_len_indication,
              &cmd9.loop_back_mode,
              &cmd9.duty_cycling_en);
#endif
      ...
      case COMMAND_D:
        ...
        scanf("%d"
              ...
              "%d",
              &cmdD.cmd_id,
              &cmdD.transmit_enable,
              &*(uint32_t *)&cmdD.device_Addr[0],
              &*(uint16_t *)&cmdD.device_Addr[4],
              &*(uint16_t *)&cmdD.pkt_len[0],
              &cmdD.pkt_type,
              &cmdD.br_edr_mode,
              &cmdD.rx_chnl_in,
              &cmdD.tx_chnl_in,
      ...
      case COMMAND_E:
        ...
        scanf("%d"
              ...
              &cmdE.cmd_id,
              &cmdE.receive_enable,
              &*(uint32_t *)&cmdE.device_Addr[0],
              &*(uint16_t *)&cmdE.device_Addr[4],
              &*(uint16_t *)&cmdE.pkt_len[0],
              &cmdE.pkt_type,
              &cmdE.br_edr_mode,
              &cmdE.rx_chnl_in,
              &cmdE.tx_chnl_in,
      ...
      case COMMAND_S:
        ...
        scanf("%d"
              ...
              &cmdS.ant_sel,
              &cmdS.gain_2g,
              &cmdS.gain_5g); //wait to receive ant_sel params
#endif
