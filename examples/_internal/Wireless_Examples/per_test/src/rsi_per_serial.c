...
void Serial_Init(void)
{
  ...
  USARTdrv->Control(ARM_USART_MODE_ASYNCHRONOUS | ARM_USART_DATA_BITS_8 | ARM_USART_PARITY_NONE | ARM_USART_STOP_BITS_1
                      | ARM_USART_FLOW_CONTROL_NONE,
                    BOARD_BAUD_VALUE); //setting the baudrate and parameters for uart data transfer
