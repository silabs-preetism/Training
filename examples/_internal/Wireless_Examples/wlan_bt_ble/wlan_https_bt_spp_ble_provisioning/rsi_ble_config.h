...
/***********************************************************************************************************************************************/
#define LE_SCAN_INTERVAL 0x0100 //0x0035
#define LE_SCAN_WINDOW   0x0050 //0x0017

#define CONNECTION_INTERVAL_MIN 0x0C8 //! 250ms
#define CONNECTION_INTERVAL_MAX 0x0C8

#define SUPERVISION_TIMEOUT (4 * CONNECTION_INTERVAL_MIN)
