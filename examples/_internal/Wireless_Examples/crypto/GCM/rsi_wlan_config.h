/*************************************************************************
 * 
 * Copyright (c) 2021 Siliocn Labs Incorporated. All Rights Reserved.
 * 
 * NOTICE:  All  information  contained  herein is, and  remains  the  property of 
 * Silion Laba Incorporated. The intellectual and technical concepts contained
 * herein  are  proprietary to  Siliocn Labs Incorporated and may be covered by 
...
#define RSI_CUSTOM_FEATURE_BIT_MAP (1 << 31) //FEAT_CUSTOM_FEAT_EXTENTION_VALID    //BIT(12) //0

//! To set Extended custom feature select bit map
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (BIT(20) | BIT(21) | (1 << 12)) //EXT_FEAT_IEEE_80211J
...
#define RSI_BAND RSI_BAND_4_9GHZ //RSI_BAND_4_9GHZ  //RSI_BAND_2P4GHZ
...
//! To configure SSID
#define RSI_CONFIG_CLIENT_SSID "none_ap"
//! RSI_BAND_2P4GHZ(2.4GHz) or RSI_BAND_5GHZ(5GHz) or RSI_DUAL_BAND
