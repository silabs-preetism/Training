/*******************************************************************************
* @file  rsi_dhcp_user_class_app.c
* @brief 
*******************************************************************************
* # License
...
#define RSI_DHCP_USER_CLASS_DATA_1        (void *)"UserClass-SiLabs1"
#define RSI_DHCP_USER_CLASS_DATA_LENGTH_1 18
#define RSI_DHCP_USER_CLASS_DATA_2        (void *)"UserClass-SiLabs2"
...
uint8_t usr_cls_length_arr[RSI_DHCP_USER_CLASS_COUNT] = { RSI_DHCP_USER_CLASS_DATA_LENGTH_1,
                                                          RSI_DHCP_USER_CLASS_DATA_LENGTH_2 };
...
int32_t rsi_dhcp_user_class_app()
{
  ...
  status = rsi_dhcp_user_class((uint8_t)mode,
                               (uint8_t)count,
...
int main()
{
  ...
  rsi_task_create((rsi_task_function_t)rsi_dhcp_user_class_app,
                  (uint8_t *)"wlan_task",
