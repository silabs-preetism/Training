/*******************************************************************************
* @file  rsi_connection_using_asynchronous_apis_app.c
* @brief 
*******************************************************************************
* # License
...
//! Application function to call connect and socket apis
int32_t rsi_connection_using_asynchronous_apis_app()
{
...
int main()
{
  ...
  rsi_task_create((rsi_task_function_t)rsi_connection_using_asynchronous_apis_app,
                  (uint8_t *)"wlan_task",
...
#else
  //! NON - OS case
  //! Call wlan asyncronous connection application
  status = rsi_connection_using_asynchronous_apis_app();
