/*******************************************************************************
* @file  rsi_ap_udp_echo_tcpipbypass.c
* @brief 
*******************************************************************************
* # License
      ...
      if (rsi_wlan_app_cb.event_map & RSI_WLAN_EVENT) {
        ...
        switch (pkt_type) {
          ...
          case RSI_IP_PACKET: {
            ...
            udp_recv(&rsi_wlan_app_cb.rx_buffer[UDP_HEADER_OFFSET],
                     (rsi_wlan_app_cb.rx_pkt_length - UDP_HEADER_OFFSET));
...
int main(void)
{
  ...
  rsi_task_create((rsi_task_function_t)rsi_wlan_ap_app,
                  (uint8_t *)"wlan_task",
