...
#define RSI_MQTT_TOPIC   (void *)"$aws/things/Test_IoT/shadow/update"
...
int32_t rsi_mqtt_client_app()
{
  ...
  rsi_wlan_register_callbacks(RSI_REMOTE_SOCKET_TERMINATE_CB, (void *)rsi_remote_socket_terminate_handler);
...
int main()
{
  ...
  rsi_task_create(rsi_mqtt_client_app,
                  "wlan_task",
