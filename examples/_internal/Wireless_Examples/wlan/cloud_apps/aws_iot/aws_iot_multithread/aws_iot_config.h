...
#define AWS_IOT_MQTT_PORT            8883          // 443 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID       "Redp" //"c-sdk-client-id" ///< MQTT client ID should be unique for every device
