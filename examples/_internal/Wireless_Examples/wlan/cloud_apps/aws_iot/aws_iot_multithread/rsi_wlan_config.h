...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP \
  (EXT_FEAT_384K_MODE | BIT(1) | BIT(3) | BIT(27) | EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE)

#define RSI_EXT_TCPIP_FEATURE_BITMAP (EXT_TCP_IP_TOTAL_SELECTS_4 | CONFIG_FEAT_EXTENTION_VALID)
