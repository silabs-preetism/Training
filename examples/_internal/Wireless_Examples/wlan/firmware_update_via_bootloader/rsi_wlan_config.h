...
//! To enable or disable the fast fw upgradation
...
#define WLAN_DEEPSLEEP        0
#define DP_SLEEP_WITH_RAM_RET 1
#define WLAN_STANDBY          1
...
#define RSI_TCP_IP_FEATURE_BIT_MAP                                      \
  (TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_SSL | TCP_IP_FEAT_DNS_CLIENT \
   | TCP_IP_FEAT_EXTENSION_VALID) //! TCP/IP feature select bitmap for selecting TCP/IP features
