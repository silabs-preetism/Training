/*******************************************************************************
* @file  rsi_ota_firmware_update_app.c
* @brief 
*******************************************************************************
* # License
 ...
 * from server
 * @section Description :
 * This application demonstrates how to upgrade new firmware to Silabs device
...
int32_t rsi_firmware_upgradation_app()
{
  ...
  do {
    status = rsi_ota_firmware_upgradation(RSI_IP_VERSION_4,
                                          (uint8_t *)&otaf_server_addr,
                                          OTAF_SERVER_PORT,
                                          chunk_number,
                                          OTAF_RX_TIMEOUT,
  ...
  // Reset the chunk number as OTA FW update is completed
  chunk_number = 1;
...
int main()
{
  ...
  rsi_task_create(rsi_firmware_upgradation_app,
                  "wlan_task",
