...
//! By default this macro should be enable
#define WYZBEE_CONFIGURATOR 1
...
#define RSI_FEATURE_BIT_MAP \
  (FEAT_SECURITY_OPEN | FEAT_AGGREGATION | FEAT_ULP_GPIO_BASED_HANDSHAKE) //(FEAT_SECURITY_OPEN )
...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_256K_MODE | BIT(1) | BIT(3) | BIT(19) | BIT(27))

#define RSI_EXT_TCPIP_FEATURE_BITMAP (EXT_TCP_IP_FEAT_SSL_MEMORY_CLOUD | BIT(31))
...
typedef enum rsi_wlan_app_state_e {
  ...
  RSI_WLAN_SCAN_STATE             = 5,
  RSI_WLAN_JOIN_STATE             = 6,
  RSI_WLAN_SOCKET_RECEIVE_STATE   = 7,

  RSI_WLAN_MQTT_INIT_STATE               = 8,
  RSI_WLAN_MQTT_CONNECT_STATE            = 9,
  ...
  RSI_WLAN_ERROR_STATE          = 13,
  RSI_WLAN_FLASH_STATE          = 14,
  RSI_WLAN_DATA_RECEIVE_STATE   = 15,
  RSI_SD_WRITE_STATE            = 16,
  RSI_WLAN_DEMO_COMPLETE_STATE  = 17
...
/*=======================================================================*/
#define PLL_MODE      0
#define RF_TYPE       0 //! 0 - External RF 1- Internal RF
