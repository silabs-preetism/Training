...
#define DHCP_MODE 1
#ifndef RSI_HIGH_PERFORMANCE_SOCKET
...
//! client,sever and new socket id
...
#else
  int8_t recv_buffer[BUF_SIZE];
  USED_CONST_PARAMETER(recv_buffer); //This statement is added only to resolve compilation warning, value is unchanged
#endif
