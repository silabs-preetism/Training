...
#ifdef RS9116
#define RSI_ZONE_RS9116_DBG     BIT(14)
#endif
#define RSI_ZONE_SDIO_DBG       BIT(15)
...
//#define RSI_GENL_ID_GENERATE            GENL_ID_GENERATE   //! GENL_ID_GENERATE  was removed from kernel 4.10, which prevents compilation of netsniff-ng.
