 ...
 * */
error_t RSI_TIMEPERIOD_RCCalibration(TimePeriodCalib_t *pstcTimePeriod,
 ...
 *			 Error code on failure
 * */
error_t RSI_TIMEPERIOD_XTAL32KHzCalibration(TimePeriodCalib_t *pstcTimePeriod,
                                            uint32_t u32TimePeriodRefClk,
                                            uint32_t u32XtalSettle,
                                            uint16_t u16RcClkCnt,
                                            boolean_t bPeriodicCalibEn,
 ...
 *			 Error code on failure
 * */
error_t RSI_TIMEPERIOD_ROCalibration(TimePeriodCalib_t *pstcTimePeriod,
                                     uint8_t u8RefClkSrc,
                                     uint32_t u32XtalSettle,
