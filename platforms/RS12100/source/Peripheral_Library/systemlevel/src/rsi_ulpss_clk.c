...
/* This API is used to enable different pheriheral clocks in ULPSS */
...
/* This API is used to enable the particular ULP peripherial Clock */
...
#endif
/* This API is used to Disable the particular ULP peripherial Clock */
...
/* This API is used to disable the timer clock */
