...
#define MCI_RESPONSE_EXPECTED (ARM_MCI_RESPONSE_SHORT      | \
...
#define COMMANDS_INTERRUPTS     (((COMMAND_TIMEOUT_ERROR_STATUS_ENABLE | COMMAND_CRC_ERROR_STATUS_ENABLE | COMMAND_END_BIT_ERROR_STATUS_ENABLE  |COMMAND_INDEX_ERROR_STATUS_ENABLE | AUTO_CMD_ERROR_STATUS_ENABLE) << 16) | \
		                             COMMAND_COMPLETE_STATUS_ENABLE )

#define DATA_INTERRUPTS       (((DATA_TIMEOUT_ERROR_STATUS_ENABLE |DATA_CRC_ERROR_STATUS_ENABLE |DATA_END_BIT_ERROR_STATUS_ENABLE ) << 16) | TRANSFER_COMPLETE_STATUS_ENABLE | \
