...
/*ROM API structure
const ROM_EGPIO_API_T egpio_api = {
		&egpio_set_dir,
		&egpio_set_pin,
		&egpio_get_pin,
		&egpio_get_dir,
		&egpio_pin_int_sel,
		&egpio_set_int_fall_edge_enable,
		&egpio_set_int_fall_edge_disable,
		&egpio_set_int_rise_edge_enable,
		&egpio_set_int_rise_edge_disable,
		&egpio_set_int_low_level_enable,
		&egpio_int_mask,
		&egpio_int_un_mask,
		&egpio_set_int_low_level_disable,
		&egpio_set_int_high_level_enable,
		&egpio_set_int_high_level_disable,
		&egpio_get_int_stat,
		&egpio_int_clr,
		&egpio_set_pin_mux,
		&egpio_ulp_soc_gpio_mode,
		&egpio_set_port_mask,
		&egpio_set_port_un_mask,
		&egpio_port_masked_load,
		&egpio_set_port,
		&egpio_port_load,
		&egpio_word_load,
		&egpio_clr_port,
		&egpio_toggle_port,
		&egpio_get_port,
		&egpio_group_int_one_enable,
		&egpio_group_int_one_disable,
		&egpio_group_int_two_enable,
		&egpio_group_int_mask,
		&egpio_group_int_un_Mask,
		&egpio_group_int_enable,
		&egpio_group_int_disable,
		&egpio_group_int_level,
		&egpio_group_int_edge,
		&egpio_group_int_and,
		&egpio_group_int_or,
		&egpio_group_int_stat,
		&egpio_group_int_wkeup_Enable,
		&egpio_group_int_wkeup_disable,
		&egpio_group_int_clr,
		&egpio_group_int_two_disable,
		&egpio_set_group_int_one_pol,
		&egpio_set_group_int_two_pol,
		&egpio_host_pads_gpio_mode_enable,
		&egpio_host_pads_gpio_mode_disable,
		&egpio_pad_selection_enable,
		&egpio_pad_selection_disable,
		&egpio_pad_receiver_enable,
		&egpio_pad_receiver_disable,
		&egpio_pad_sdio_connected,
		&egpio_pad_driver_disable_state,
		&egpio_pad_driver_strength_select,
		&egpio_pad_power_on_start_enable,
		&egpio_pad_active_high_schmitt_trigger,
		&egpio_pad_slew_rate_controll,
		&egpio_ulp_pad_receiver_enable,
		&egpio_ulp_pad_receiver_disable,
		&egpio_ulp_pad_driver_disable_state,
		&egpio_ulp_pad_driver_strength_select,
		&egpio_ulp_pad_power_on_start_enable,
		&egpio_ulp_pad_active_high_schmitt_trigger,
		&egpio_ulp_pad_slew_rate_controll
};	
