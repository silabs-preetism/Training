 ...
 * @par            Example     - RSI_COMP_Config(COMPARATOR_1,COMP1,
 *                                               COMP1_POSITIVE_INPUT,
 *																							 COMP1_NEGATIVE_INPUT,
 ...
 * @return       - \ref RSI_OK If valid comp
 *                   else if fail return Invalid parameters.
 * @par            Example      -	RSI_COMP_Enable(COMPARATOR_1,COMP1,ENABLE,METAL_REV1P3); 
 */
 ...
 * @return       - \ref RSI_OK If valid comp
 *                   else if fail return Invalid parameters.
 * @par          Example   - RSI_COMP_ReferenceScalarOut(COMPARATOR_1,scalar_factor_value,METAL_REV1P3);    
 */
 ...
 * @return       - \ref RSI_OK If valid comp
 *                   else if fail return Invalid parameters.
 * @par          Example   - RSI_COMP_ReferenceScalarOut(COMPARATOR_1,ENABLE);    
 */
 ...
 * @return       - \ref RSI_OK If valid comp
 *                   else if fail return Invalid parameters.
 * @par          Example      -RSI_COMP_IntrEnableDisable(COMPARATOR_1,ENABLE)
 */
 ...
 * @return       - \ref RSI_OK If valid comp
 *                   else if fail return Invalid parameters.
 * @par          Example     - RSI_COMP_PinMux(COMPARATOR_1,sel_p_mux,sel_n_mux)
 */
