...
/**
 * @fn           RSI_SD_HostInit(SMIH_CARD_CONFIG_T *pSmihConfig ,ARM_SMIH_SignalEvent_t Event,uint8_t MemType)
...
/**
 * @fn           error_t smih_uhs_mode_select(SMIH_UHS_MODE_T UhsMode)
...
/**
 * @fn           error_t smih_clock_config( uint32_t freq )
