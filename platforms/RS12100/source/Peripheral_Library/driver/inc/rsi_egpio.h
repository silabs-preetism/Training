 ...
 * Includes
 */
#ifndef __RSI_EGPIO_H__
#define __RSI_EGPIO_H__
...
NOTE : Total 8 pin interrupts are supported , these interrupts can be
mapped to any of the GPIO ports 
 **/
...
/*** Pin multiplexing
NOTE : Each GPIO supports up to 8 multiplexing functions 
those can be selected by passing following macros into the 
pin mux function***/
...
#define SDIO_CNTD_TO_TASS \
  (*(volatile uint32_t *) \
     NWPAON_MEM_HOST_ACCESS_CTRL_CLEAR) /*!< sdio connected to tass  (0 for M4SS and 1 for TASS)                */
