...
typedef struct {
  uint32_t NoOfInputs : 3;    /*!< Number of Input signals                           */
  uint32_t NoOfOutputs : 4;   /*!< Number of Output signlas                          */
  uint32_t NumOfCounters : 4; /*!< Number of Counters present in CT module           */
  uint32_t NoOfEvents : 6;    /*!< Number of Events can be generated by input events */
  uint32_t DMAIntf : 1;       /*!< Supports DMA interface or not                     */
...
/**
 * @fn          void RSI_CT_StartEventConfig(RSI_CT_T *pCT,uint32_t andValue,
																						 uint32_t orValue)	
...
/**
 * @fn          void RSI_CT_StopEventConfig(RSI_CT_T *pCT,uint32_t andValue,
																						uint32_t orValue)
...
/**
 * @fn          void RSI_CT_ContinueEventConfig(RSI_CT_T *pCT,uint32_t andValue,
																						    uint32_t orValue)	
...
/**
 * @fn          void RSI_CT_HaltEventConfig(RSI_CT_T *pCT,uint32_t andValue,
							 																						   uint32_t orValue)	
...
/**
 * @fn   			  void RSI_CT_IncrementEventConfig(RSI_CT_T *pCT,uint32_t andValue,
																																  uint32_t orValue)
...
/**
 * @fn          void RSI_CT_CaptureEventConfig(RSI_CT_T *pCT,uint32_t andValue,
																															uint32_t orValue)
...
/**
 * @fn          void RSI_CT_InterruptEventConfig(RSI_CT_T *pCT,uint32_t andValue,
																																  uint32_t orValue)
...
/**
 * @fn          void RSI_CT_OutputEventConfig( RSI_CT_T *pCT,uint32_t andValue,
							 																 uint32_t orValue)
...
/**
 * @fn          void RSI_CT_OutputEventADCTrigger(RSI_CT_MUX_REG_T *pCTmux,
...
/**
 * @fn          void RSI_CT_SetTimerMuxSelect( RSI_CT_MUX_REG_T *pCTMux, 
                                             uint8_t timerIns )
...
/** 
 * @fn          error_t RSI_CT_PeripheralReset(RSI_CT_T *pCT, 
...
/**
 * @fn           error_t RSI_CT_StartSoftwareTrig(RSI_CT_T *pCT, 
																								boolean_t counterNum)
...
/** 
 * @fn          void RSI_CT_SetMatchCount(RSI_CT_T *pCT, uint32_t value, 
                           boolean_t counterMode, boolean_t counterNum) 
...
/**
 * @fn          uint32_t RSI_CT_GetCounter( RSI_CT_T *pCT,boolean_t counterNum,
                                            boolean_t mode )
 * @brief		    Gets the captured counter value 
 * @param[in]   pCT         : Pointer to the CT instance register area
 * @param[in]   counterNum  : Counter 0/1
...
/**
 * @fn          void RSI_CT_SetCounerSync( RSI_CT_T *pCT, uint8_t syncCounter, 
																						boolean_t counterNum)
