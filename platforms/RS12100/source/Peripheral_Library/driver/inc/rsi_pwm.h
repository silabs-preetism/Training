...
#ifndef __RSI_PWM_H__
#define __RSI_PWM_H__
...
#define RSI_MCPWM_EVENT_TIME_PERIOD_MATCH_CH0 \
  (1UL << 1)                               /*!< Time base match for 0th channel which considering postscaler 	*/
...
#define RSI_MCPWM_EVENT_TIME_PERIOD_MATCH_CH2 \
  (1UL << 7) /*!< Time base match for 2nd channel which considering postscaler 	*/
...
/**
 * @fn          error_t RSI_MCPWM_DutyCycleControlSet(RSI_MCPWM_T *pMCPWM,uint32_t value,
																											uint8_t chnlNum)
...
/**
 * @fn          error_t RSI_MCPWM_DutyCycleControlReset(RSI_MCPWM_T *pMCPWM,uint32_t value,
                                                        uint8_t chnlNum)
...
/**
 * @fn          error_t RSI_MCPWM_OutputOverrideEnable(RSI_MCPWM_T *pMCPWM,
																											 uint8_t pwmOutput)
...
/**
 * @fn          error_t RSI_MCPWM_OutputOverrideDisable(RSI_MCPWM_T *pMCPWM,
																												uint8_t pwmOutput)
 ...
 * @brief		    This API is used to set the override control parameter, 
								output is synced with pwm time period depending on operating mode
 * @param[in]	  pMCPWM  :  Pointer to the MCPWM instance register area
...
/**
 * @fn          void RSI_MCPWM_OverrideValueSet(RSI_MCPWM_T *pMCPWM,uint8_t pwmOutput,
																								 uint8_t value)
...
/**
 * @fn          error_t RSI_MCPWM_OverrideValueReSet(RSI_MCPWM_T *pMCPWM,uint8_t pwmOutput,
																									   uint8_t value)
 ...
 * @brief		    This API is used to enable generation of special 
								event trigger for required channel of MCPWM  
 * @param[in]	  pMCPWM  :  Pointer to the MCPWM instance register area
 * @return 		  none
 */
 ...
 * @brief		    This API is used to disable generation of special 
								event trigger for required channel of MCPWM  
 * @param[in]	  pMCPWM  :  Pointer to the MCPWM instance register area
 * @return 		  none
 */
 ...
 * @param[in]	  value		:  This can be logical OR of below parameters
													 - DEADTIME_SELECT_ACTIVE  : Deadtime select bits for PWM going active
																											 ...
																											 \n if bit zero then use counter A , if one then use counter B  
...
/**
 * @fn          void RSI_MCPWM_DeadTimeControlReSet(RSI_MCPWM_T *pMCPWM, 
																							      uint32_t value )
...
/**
 * @fn          error_t RSI_MCPWM_SetDutyCycle(RSI_MCPWM_T *pMCPWM, uint16_t dutyCycle,
																							 uint8_t chnlNum)
 ...
 * @brief		    This API is used to enable to use external trigger for base time counter increment
                or decrement of MCPWM 
 * @param[in]	  pMCPWM  :  Pointer to the MCPWM instance register area
 ...
 * @brief		    This API is used to select number of base timers as four base timers for four channels 
								or one base timer for all channels of MCPWM
 * @param[in]	  pMCPWM   :  Pointer to the MCPWM instance register area
