...
#ifndef __RSI_RPDMA_H__
#define __RSI_RPDMA_H__
...
#define RPDMA_STAT_RPDMAC_ERROR0 \
  (1UL << 3) /*! Channel0 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
#define RPDMA_STAT_RPDMAC_ERROR1 \
  (1UL << 7) /*! Channel1 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
#define RPDMA_STAT_RPDMAC_ERROR2 \
  (1UL << 11) /*! Channel2 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
#define RPDMA_STAT_RPDMAC_ERROR3 \
  (1UL << 15) /*! Channel3 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
#define RPDMA_STAT_RPDMAC_ERROR4 \
  (1UL << 19) /*! Channel4 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
#define RPDMA_STAT_RPDMAC_ERROR5 \
  (1UL << 23) /*! Channel5 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
#define RPDMA_STAT_RPDMAC_ERROR6 \
  (1UL << 27) /*! Channel6 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
#define RPDMA_STAT_RPDMAC_ERROR7 \
  (1UL << 31) /*! Channel7 Transfer size/burst size /h size mismatch/flow ctrl err status */
...
/* Private data structure used for the RPDMA controller driver, holds the driver and
   peripheral context */
typedef struct {
 ...
 * \defgroup RSI_RPDMA_DRIVER RSI:RS1xxxx RPDMA 
 *  @{
 *
 */
