 ...
 *
 * @section description
 * This function Enroll PUF if not blocked earlier
 *
 */
 ...
 *
 * @section description
 * This function Blocks further Enrolls of PUF
 *
 */
...
/*==============================================*/
/**
 * @fn         rsi_puf_aes_mac_req(uint16_t key_size, uint8_t *key_ptr, uint16_t data_size,
