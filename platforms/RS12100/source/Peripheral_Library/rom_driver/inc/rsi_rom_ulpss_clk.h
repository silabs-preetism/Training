 ...
 * @return 		  returns 0 \ref RSI_OK on success ,Error code on failure
 */
STATIC INLINE error_t RSI_ULPSS_ClockConfig(M4Clk_Type *pCLK,
                                            boolean_t clkEnable,
                                            uint16_t divFactor,
...
STATIC INLINE error_t RSI_ULPSS_UlpSsiClkConfig(ULPClk_Type *pULPCLK,
 ...
 *               \n please refer RSI_ULPSS_ClockConfig(M4Clk_Type *pCLK,boolean_t clkEnable,uint16_t  divFactor,boolean_t  oddDivFactor);
 */
STATIC INLINE error_t RSI_ULPSS_UlpUartClkConfig(ULPClk_Type *pULPCLK,
                                                 CLK_ENABLE_T clkType,
                                                 boolean_t bFrClkSel,
 ...
 *                \n please refer RSI_ULPSS_ClockConfig(M4Clk_Type *pCLK,boolean_t clkEnable,uint16_t  divFactor,boolean_t  oddDivFactor);
 */
STATIC INLINE error_t RSI_ULPSS_TimerClkConfig(ULPClk_Type *pULPCLK,
                                               CLK_ENABLE_T clkType,
                                               boolean_t bTmrSync,
 ...
 *               \n please refer RSI_ULPSS_ClockConfig(M4Clk_Type *pCLK,boolean_t clkEnable,uint16_t  divFactor,boolean_t  oddDivFactor);
 */
STATIC INLINE error_t RSI_ULPSS_AuxClkConfig(ULPClk_Type *pULPCLK, CLK_ENABLE_T clkType, ULP_AUX_CLK_SELECT_T clkSource)
{
#if defined(ROMDRIVER_PRESENT)
 ...
 * @return 		  returns 0 \ref RSI_OK on success ,Error code on failure
 */
STATIC INLINE error_t RSI_ULPSS_PeripheralEnable(ULPClk_Type *pULPCLK,
...
error_t RSI_ULPSS_UlpI2sClkConfig(ULPClk_Type *pULPCLK, ULP_I2S_CLK_SELECT_T clkSource, uint16_t divFactor);
...
error_t RSI_ULPSS_AuxClkConfig(ULPClk_Type *pULPCLK, CLK_ENABLE_T clkType, ULP_AUX_CLK_SELECT_T clkSource);
...
error_t RSI_ULPSS_TouchClkConfig(ULPClk_Type *pULPCLK, ULP_TOUCH_CLK_SELECT_T clkSource, uint16_t divFactor);
